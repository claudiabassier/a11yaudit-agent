...
Als Nächstes laut Fahrplan: Woche 1b — **Hand-Scoring** der zwei Fixtures gegen AI-Verdikt (Arbeitsblätter fertig: `docs/hand-scoring-worksheet.md` + `docs/hand-scoring-ai-verdicts.md`, das eigentliche Scoren ist Aufgabe des Autors), danach 5–10 reale Seiten, Auswertungskorpus. **Repo bleibt privat, bis Phase 2 fertig ist.**
